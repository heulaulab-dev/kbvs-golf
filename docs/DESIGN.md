...
:root {
	...
	--font-untitledseriffont:
		'UntitledSerifFont', ui-serif, Georgia, Cambria, 'Times New Roman', Times,
		serif;
	--font-untitledsansfont:
		'UntitledSansFont', ui-sans-serif, system-ui, -apple-system,
	...
	/* Shadows */
	--shadow-xl:
		rgba(0, 0, 0, 0.01) 0px 50px 40px 0px,
		rgba(0, 0, 0, 0.02) 0px 50px 40px 0px,
		rgba(0, 0, 0, 0.05) 0px 20px 40px 0px, rgba(0, 0, 0, 0.08) 0px 3px 10px 0px;
	--shadow-sm:
		rgba(0, 0, 0, 0.1) 0px 4px 6px -1px, rgba(0, 0, 0, 0.1) 0px 2px 4px -2px;
	--shadow-md:
		rgba(0, 0, 0, 0.1) 0px 12px 12px 2px, rgba(0, 0, 0, 0.06) 0px 2px 4px -1px;
